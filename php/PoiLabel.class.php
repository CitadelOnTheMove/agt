...
class PoiLabel {
    ...
    public $type;
    public $text;
    public $tplIdentifier;

    /**
     * Creates a new instance of the PoiLabel object
    ...
    /**
     * Saves the PoiLabel instance to the database
    ...
    /**
     * Fetches a PoiLabel instance from database based on the poi id
     * (Initialize object from db)
     * @param int $poiId
     * @return PoiLabel|boolean a new PoiLabel object or false if not found
     */
    public static function createFromDb($poiId) {
        $sql = "SELECT * FROM poilabels	WHERE poi_id = :id";
        $sqlParams[':id'] = $poiId;
    ...
    public static function createFromArray($assocArray) {
        if (isset($assocArray['term']) && isset($assocArray['type']) && isset($assocArray['text']) && isset($assocArray['tplIdentifier']))
            return new PoiLabel($assocArray['term'], $assocArray['type'], $assocArray['text'], $assocArray['tplIdentifier']);
        return false;
    }
